...
public class View_visitorlog extends AppCompatActivity {
    ...
    String[] id,name,photo, time, date,val;
    @Override
...
//                                status = new String[js.length()];
                                ...
                                for (int i = 0; i < js.length(); i++) {
                                    ...
                                    id[i] = u.getString("visitor_log_id");//dbcolumn name in double quotes
...
//                                    val[i]="\tReport Description :"+complaint[i]+"\n\tReply :"+reply[i]+"\n\tStatus :"+date[i];
                                ...
                                li.setAdapter(new Cust_visit(View_visitorlog.this,name,date,time,photo));

//                                li.setAdapter(new Cust_visit(this, name, date, time,photo));//custom_view_service.xml and li is the listview object
