...
public class Cust_alert extends ArrayAdapter<String>  {
    ...
    public Cust_alert(Activity context, String[] lname, String[] email, String[] photo) {
        //constructor of this class to get the values from main_activity_class

        super(context, R.layout.activity_cust_alert, lname);
...
//
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.activity_cust_alert, null, true);
