...
public class manage_family extends AppCompatActivity implements View.OnClickListener {
    ImageView img;
    EditText name, email, place, phone,district, type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        type = findViewById(R.id.editTextTextPersonName9);
...
//            String psw1 = password.getText().toString().trim();
            ...
            if (name1.isEmpty()) {
                ...
                type.setError("Please enter a username");
                isValid = false;
...
//            }
            ...
            if (isValid) {
                ...
                String url = sh.getString("url", "") + "manage_family";
...
//                                ed.commit();
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        params.put("type", type1);//passing to python
//                        params.put("password", psw1);//passing to python
                        params.put("uid", o.getString("uid",""));

                        Log.d("dddddddddddddddd", "uid");
                        Log.d("dddddddddddddddd", "type");
                        Log.d("dddddddddddddddd", "district");
                ...
                Intent intent = new Intent(getApplicationContext(), manage_family.class);
                startActivity(intent);
            }else {
    ...
    private void selectImageOption() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(manage_family.this);
