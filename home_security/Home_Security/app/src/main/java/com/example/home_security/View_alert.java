...
public class View_alert extends AppCompatActivity {
...
//                                status = new String[js.length()];
                                ...
                                for (int i = 0; i < js.length(); i++) {
                                    ...
                                    id[i] = u.getString("alert_id");//dbcolumn name in double quotes
...
//                                    val[i]="\tReport Description :"+complaint[i]+"\n\tReply :"+reply[i]+"\n\tStatus :"+date[i];
                                ...
                                li.setAdapter(new Cust_alert(View_alert.this,date,time,photo));
